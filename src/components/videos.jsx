...
function videos(){
    return(
    <>
    <Parallax pages={2} style={{backgroundImage:`url(${beachDarkBackground})`, backgroundSize: `contain`}}>
        <ParallaxLayer>
            <center>
                <h1 style={{color:"white", WebkitTextStroke: "2px black", fontSize:"25px"}}>Page Not Supported On Mobile</h1>
                <h1 style={{color:"white", WebkitTextStroke: "2px black", fontSize:"50px"}}>Trailer</h1>
                <iframe width="850" height="480.36" src="https://www.youtube.com/embed/B-YwPsuCMps?si=LSdsohgtk5jqicbl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
